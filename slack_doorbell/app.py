...
PROCESS_DB_TBL      = os.environ['PROCESS_DB_TBL']  # DynamoDB Table that Stores processed image hashes
...
def lambda_handler(event, context):
    ...
    post_image( config['channel'], msg, img_data )
